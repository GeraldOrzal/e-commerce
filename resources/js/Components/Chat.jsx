...
export default function Chat(props) {
    ...
    return (
        ...
        !isOpen?<div className='bg-secondary text-primary absolute w-1/3 h-10 bottom-0 ml-5 border rounded-t-md flex flex-row items-center p-3 border-b-2' onClick={()=>setisOpen(true)}>
                <label
                    className='flex-1'
                >Gerald Orzal</label>
                <MdClose />
        ...
        <div className='bg-primary text-black absolute w-1/3 h-3/5 bottom-0 ml-5 border rounded-t-md flex flex-col' >
