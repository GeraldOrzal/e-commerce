...
export default function SearchBar(props) {
    ...
    return (
        <>
            ...
            sm:flex-row 
            xs:flex-col'>
                <Link href={props.auth.user ? route('shop', { page: 1 }) : route("index")} className="mr-2 
                md:w-20 md:h-20
                sm:w-14 sm:h-14
                xs:w-28 xs:h-28">
                    <ApplicationLogo />
                ...
                xs:flex-col'>
                    ...
                    sm:px-0
                    xs:px-2'>
                        <input ref={inputRef} type='text' className='bg-black bg-opacity-10 pl-5 outline-0 rounded-bl-xl p-2 w-full
                    md:text-base
                ...
                xs:text-base'/>}</button>
                    ...
                    sm:w-32 sm:mt-0 sm:justify-start
                    xs:w-full xs:mt-2 xs:justify-center'>
                        {
                            props.auth.user ? <>
