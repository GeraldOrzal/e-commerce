        ...
        <Guest>
            ...
            <form onSubmit={submit}>
                ...
                <div className="mt-4 flex flex-row items-center">
                    <div className='bg-black bg-opacity-10 p-2'><BsPerson className='text-2xl text-disable' /></div>
                    <Input
                        type="text"
                        name="name"
                        value={data.name}
                ...
                <div className="mt-4 flex flex-row items-center">
                    <div className='bg-black bg-opacity-10 p-2'><BsEnvelope className='text-2xl text-disable' /></div>
                    <Input
                        type="email"
                        name="email"
                        value={data.email}
                ...
                <div className="mt-4 flex flex-row items-center">
                    <div className='bg-black bg-opacity-10 p-2'><BsLock className='text-2xl text-disable' /></div>
                    <Input
                        type="password"
                        name="password"
                        value={data.password}
